...
public class AdaptetTop extends RecyclerView.Adapter<AdaptetTop.Holder> {

    ArrayList<DataItem> dataItems;
    private Context context;

    public AdaptetTop(ArrayList<DataItem> dataItems, Context context) {
    ...
    @NonNull
    @Override
    public AdaptetTop.Holder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(context).inflate(R.layout.recycler_item,parent,false);
        return new AdaptetTop.Holder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull AdaptetTop.Holder holder, int position) {
