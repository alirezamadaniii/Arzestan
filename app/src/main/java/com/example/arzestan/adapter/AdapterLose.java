...
public class AdapterLose extends RecyclerView.Adapter<AdapterLose.Holder> {
    ...
    public AdapterLose(ArrayList<DataItem> dataItems, Context context) {
    ...
    @NonNull
    @Override
    public AdapterLose.Holder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(context).inflate(R.layout.recycler_item,parent,false);
        return new AdapterLose.Holder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull AdapterLose.Holder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Navigation.findNavController(v).navigate(R.id.action_fragmentHome_to_fragmentItemSelect,bundle);
